...
@section('auth-content')
    <div style="text-align:center;margin-bottom:22px;animation:fade-up .4s both;">
        <div
            style="width:52px;height:52px;border-radius:14px;background:rgba(139,92,246,.15);border:1px solid rgba(139,92,246,.25);display:flex;align-items:center;justify-content:center;margin:0 auto 12px;">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                <rect x="5" y="11" width="14" height="9" rx="2" stroke="#8b5cf6" stroke-width="1.5"/>
                <path d="M8 11V7a4 4 0 018 0v4" stroke="#8b5cf6" stroke-width="1.5" stroke-linecap="round"/>
                <circle cx="12" cy="15.5" r="1.2" fill="#8b5cf6"/>
            </svg>
        </div>
        <h1 class="auth-heading" style="margin-bottom:4px;">Confirm password</h1>
        <p class="auth-sub" style="margin-bottom:0;font-size:12px;">This is a secure area. Please confirm your password
            to continue.</p>
    </div>
      ...
      <span class="form-icon">
        <svg width="15" height="15" viewBox="0 0 18 18" fill="none"><rect x="4" y="8" width="10" height="7" rx="1.5"
                ...
                <input type="password" id="password" name="password" class="form-input"
                       placeholder="Your current password" required autofocus autocomplete="current-password">
