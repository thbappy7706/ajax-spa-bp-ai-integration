...
@section('auth-content')
    ...
    <form method="POST" action="{{ route('register') }}">
      ...
      <span class="form-icon">
        <svg width="15" height="15" viewBox="0 0 18 18" fill="none"><circle cx="9" cy="6" r="3.2" stroke="currentColor"
                                                                            stroke-width="1.3"/><path
                d="M2.5 16c0-3.5 2.9-5.5 6.5-5.5s6.5 2 6.5 5.5" stroke="currentColor" stroke-width="1.3"
                stroke-linecap="round"/></svg>
      </span>
                <input type="text" id="name" name="name" class="form-input" placeholder="Alex Rivera"
      ...
      <span class="form-icon">
        ...
        <div class="form-group">
            <label class="form-check">
                ...
                <span>I agree to the <a href="#" style="color:var(--accent);text-decoration:none;">Terms</a> &amp; <a
                        href="#" style="color:var(--accent);text-decoration:none;">Privacy Policy</a></span>
            </label>
        </div>
