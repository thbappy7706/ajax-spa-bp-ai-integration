...
<div class="topbar fi">
    <div>
        <h1 class="ptitle">Edit Category</h1>
        <div class="psub">Update post category.</div>
    </div>
    ...
    <form id="categoryForm" onsubmit="updateCategory(event)">
        <div class="frow">
            <div class="form-floating">
                <input type="text" class="inp" id="name" name="name" placeholder="Name" value="{{ $category->name }}" required>
        ...
        <div class="form-floating" style="margin-top: 10px;">
            <textarea class="inp" id="description" name="description" placeholder="Description" style="height: 120px;">{{ $category->description }}</textarea>
            <label for="description">Description</label>
        </div>

        <div style="text-align: right; margin-top: 20px;">
            <button type="submit" class="btn p">Update Category</button>
        </div>
    </form>
</div>
