    ...
    <style>
        ...
        *, *::before, *::after {
        ...
        .btn-primary:hover {
            ...
            box-shadow: 0 8px 28px rgba(14, 165, 233, .45), 0 0 0 1px rgba(255, 255, 255, .15) inset;
...
<script>
    ...
    document.querySelectorAll('.otp-input').forEach((inp, i, all) => {
        ...
        inp.addEventListener('paste', e => {
            ...
            digits.slice(0, 6).forEach((d, j) => {
                if (all[i + j]) all[i + j].value = d;
            });
