...
<div class="topbar fi">
    <div>
        <h1 class="ptitle">Add Comment</h1>
        <div class="psub">Add a new comment to a post.</div>
    </div>
...
<div class="card fi" style="max-width: 900px; margin: 0 auto; padding: 30px;">
    <form id="commentForm" onsubmit="submitComment(event)">
        ...
        <div class="form-floating" style="margin-top: 10px;">
            <textarea class="inp" id="content" name="content" placeholder="Content" style="height: 150px;" required></textarea>
            <label for="content">Comment Content</label>
        </div>

        <div style="text-align: right; margin-top: 20px;">
            <button type="submit" class="btn p">Save Comment</button>
        </div>
    </form>
</div>
