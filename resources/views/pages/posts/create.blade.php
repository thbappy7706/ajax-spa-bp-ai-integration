...
<div class="topbar fi">
    <div>
        <h1 class="ptitle">Create Post</h1>
        <div class="psub">Write a new blog post.</div>
    </div>
...
<div class="card fi" style="max-width: 900px; margin: 0 auto; padding: 30px;">
    <form id="postForm" onsubmit="submitPost(event)">
        <div class="form-floating">
            <input type="text" class="inp" id="title" name="title" placeholder="Title" required>
        ...
        <div class="form-floating" style="margin-top: 10px;">
            <textarea class="inp" id="content" name="content" placeholder="Content" style="height: 200px;" required></textarea>
            <label for="content">Post Content</label>
        </div>

        <div style="text-align: right; margin-top: 20px;">
            <button type="submit" class="btn p">Save Post</button>
        </div>
    </form>
</div>
